...
function Persona(nombre, edad) {
  ...
  this.nombre = nombre;
  this.edad = edad; // - definimos una variable que tiene asignada una función sin identificador
  ...
  this.preguntar = function (modo) {
    console.log(_this); // manejamos las alternativas con if/else, podríamos haber usado switch

    if (modo == 1) console.log('Que tal?');else if (modo == 2) console.log('Cómo estas?');
  };
...
Persona.prototype.saludar = function (nombre) {
  console.log("Hola ".concat(nombre)); // <-- Feature de ES6/ECMAScript6/ES2015
  // console.log('Hola '+ nombre);
};

Persona.prototype.despedirse = function (nombre) {
  console.log("Chau ".concat(nombre)); // <-- Feature de ES6/ECMAScript6/ES2015
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/funciones.js"], null)
//# sourceMappingURL=/funciones.19a20a06.js.map